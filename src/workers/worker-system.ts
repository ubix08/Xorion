// src/workers/worker-system.ts
// Specialized Worker Registry and Execution System

import type { GeminiClient } from '../gemini';

// =============================================================
// Worker Envelope Types
// =============================================================
...
- Include code for visualizations if needed`,
    tools: ['code_execution', 'memory_search'],
    defaultMaxTurns: 5,
...
- Provide usage examples`,
    tools: ['code_execution', 'web_search', 'memory_search'],
    defaultMaxTurns: 6,
...
- Proper citations
- Actionable recommendations`,
    tools: ['memory_search', 'code_execution'],
    defaultMaxTurns: 4,
...
`;
  ...
  private extractOutput(output: string): string {
    // Try to extract after completion marker
    const markers = [
      'task complete',
      'final output:',
      'completed:',
  ...
  private async assessQuality(
    ...
    // Simple heuristic assessment for now
    const issues: string[] = [];
